...
public class ProPushAdapter extends BaseAdapter {
    private Context context;
    private List<ProPushVo> proPushVoList;

    public ProPushAdapter(Context context, List<ProPushVo> proPushVoList) {
        this.context = context;
        this.proPushVoList = proPushVoList;
    }

    @Override
    public int getCount() {
        return proPushVoList.size();
    }

    @Override
    public Object getItem(int position) {
        return proPushVoList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        myViewHolder.remind_content.setText(proPushVoList.get(position).getMESSAGE());
        String logIme = proPushVoList.get(position).getPRO_TIME();
