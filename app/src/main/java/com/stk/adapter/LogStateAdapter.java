...
public class LogStateAdapter extends BaseAdapter {

    private Context context;
    private List<LogStateVo> logStateVoList;

    public LogStateAdapter(Context context, List<LogStateVo> logStateVoList) {
        this.context = context;
        this.logStateVoList = logStateVoList;
    }

    @Override
    public int getCount() {
        return logStateVoList.size();
    }

    @Override
    public Object getItem(int position) {
        return logStateVoList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        myViewHolder.remind_content.setText(logStateVoList.get(position).getMESSAGE());
        String logIme = logStateVoList.get(position).getLOG_TIME();
