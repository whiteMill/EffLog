...
public class LogPushAdapter extends BaseAdapter{

    private Context context;
    private List<LogPushVo> logPushVoList;

    public LogPushAdapter(Context context, List<LogPushVo> logPushVoList) {
        this.context = context;
        this.logPushVoList = logPushVoList;
    }

    @Override
    public int getCount() {
        return logPushVoList.size();
    }

    @Override
    public Object getItem(int position) {
        return logPushVoList.get(position);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        myViewHolder.remind_content.setText(logPushVoList.get(position).getLOG_CONTENT());
        String logIme = logPushVoList.get(position).getLOG_TIME();
