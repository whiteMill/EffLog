...
public class PlanDetailActivty extends AppCompatActivity implements View.OnClickListener,PopupMenu.OnMenuItemClickListener{
   ...
   // private AlertDialog.Builder builder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_plan_activty);
        mWeiboDialog = WeiboDialogUtils.createLoadingDialog(PlanDetailActivty.this, "正在加载");
        initView();
        intent = getIntent();
        logPushVo  = (LogPushVo) intent.getSerializableExtra("logPushVo");
        log_type = logPushVo.getLOG_TYPE();
        Log.d("sfasfaggggg",logPushVo.toString());
        queryLog();
        QueryComment();
        outTimeListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(PlanDetailActivty.this,updateLogActivity.class);
    ...
    public boolean onMenuItemClick(MenuItem item) {
        switch (item.getItemId()){
            case R.id.add:
                break;
            case R.id.delete:
                alertDialog = new AlertDialog.Builder(PlanDetailActivty.this).setTitle("提醒").setMessage("确定要删除吗？")
    ...
    private void QueryComment(){
        OkGo.post(URL.QUERY_COMMENT)
                .tag(this)
                .params("LOG_INDEX",logPushVo.getLOG_INDEX())
                .cacheKey("catchKey")
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        try {
                            ...
                            if(isSuccess){
                                ...
                                commentListView.setAdapter(new CommentAdapter(PlanDetailActivty.this,commentVoList));

                            }else{
                                Toast.makeText(PlanDetailActivty.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                            }
    ...
    private void  initDate(List<LogVo> mList){
        ...
        outTimeListView.setAdapter(new WorkItemAdapter(PlanDetailActivty.this,outTimeList));
        unComListView.setAdapter(new WorkItemAdapter(PlanDetailActivty.this,unComList));
        comListView.setAdapter(new WorkItemAdapter(PlanDetailActivty.this,comList));
    }
    ...
    private void queryLog() {
        OkGo.post(URL.LOG_QUERY_LOG_INDEX)
                .tag(this)
                .params("USER_ID",logPushVo.getUSER_ID())
                .params("LOG_TYPE",logPushVo.getLOG_TYPE())
                .params("LOG_INDEX",logPushVo.getLOG_INDEX())
                .cacheKey("catchKey")
                .cacheMode(CacheMode.DEFAULT)
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        try {
                            ...
                            Toast.makeText(PlanDetailActivty.this,"日志获取失败", Toast.LENGTH_SHORT).show();
                        }
                    }
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        WeiboDialogUtils.closeDialog(mWeiboDialog);
                        Toast.makeText(PlanDetailActivty.this,"服务器请求失败", Toast.LENGTH_SHORT).show();
                        super.onError(call, response, e);
                    }
                });
    }
