...
public class AddBussActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initView() {
        ...
        bussName = (EditText) findViewById(buss_name);
        ...
        if(requestCode ==REQUEST_CODE){
            switch (resultCode){
                case USER_CODE:
                    ...
                    joinAdapter = new JoinAdapter(AddBussActivity.this,contactUsers);
                ...
                case USER_DELETE:
                    ...
                    joinAdapter = new JoinAdapter(AddBussActivity.this,deleteListUser);
                    joinListView.setAdapter(joinAdapter);
                    break;
                case ADD_MANA:
                    ...
                    joinAdapter = new JoinAdapter(AddBussActivity.this,manaContactUsers);
                ...
                case DELETE_MANA:
                    ...
                    joinAdapter = new JoinAdapter(AddBussActivity.this,manaDeleList);
                    manaListView.setAdapter(joinAdapter);
                    break;
            }
        }
         ...
         switch (v.getId()){
             ...
             case R.id.save:
                 if(bussName.getText().toString().trim().isEmpty()){
                     Toast.makeText(this, "请输入商机名称zzz", Toast.LENGTH_SHORT).show();
                 }else{
                     mWeiboDialog = WeiboDialogUtils.createLoadingDialog(AddBussActivity.this, "正在提交");
                     addBuss();
                 }
                 break;
             case R.id.beginTime:
             ...
             case R.id.addPeo:
                 Intent addIntent = new Intent(AddBussActivity.this,AllUserActivity.class);
                 ...
                 break;
             case R.id.deletePeo:
                 Intent deleteIntent = new Intent(AddBussActivity.this,AllUserActivity.class);
             ...
             case R.id.addManaPeo:
                 Intent addManaIntent = new Intent(AddBussActivity.this,AllUserActivity.class);
             ...
             case R.id.deleteManaPeo:
                 Intent deleteManaIntent = new Intent(AddBussActivity.this,AllUserActivity.class);
    ...
    private void addBuss(){
        ...
        OkGo.post(URL.ADD_BUSSINESS)
                .tag(this)
                .params("USER_ID",MyApplication.getUserVo().getUSER_ID())
                .params("BUSS_NAME",bussName.getText().toString().trim())
                .params("BUSS_RESOURCE",bussRes.getText().toString().trim())
                .params("BUSS_INFO",bussDetail.getText().toString().trim())
                .params("BEGIN_TIME",beginTime.getText().toString())
                .params("END_TIME",endTime.getText().toString())
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        try {
                            jsonObject = new JSONObject(s);
                            if(jsonObject.getBoolean("success")){
                                Toast.makeText(AddBussActivity.this, "商机添加成功", Toast.LENGTH_SHORT).show();
                                finish();
                            }else{
                                Toast.makeText(AddBussActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
