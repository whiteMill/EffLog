...
import static com.stk.efflog.R.id.buss_detail;
...
public class ProjectEditActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private TextView proUpdateFlag;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_project_edit); initView();
        intent = getIntent();
        projectVo = (ProjectVo)getIntent().getSerializableExtra("proVo");
        ...
        pro_name.setText(projectVo.getPROJECT_NAME());
     //  buss_resource.setText(bussinessVo.getBUSS_RESOURCE());
        pro_detail.setText(projectVo.getPROJECT_INFO());
        beginTime.setText(projectVo.getPROJECT_BEGIN_TIME());
        endTime.setText(projectVo.getPROJECT_END_TIME());

        joinName.setText("1---"+projectVo.getNAME());

        manaName.setText("1---"+projectVo.getNAME());

        initDate();
        setData();

        if(!isMana){
            pro_name.setKeyListener(null);
        //    buss_resource.setKeyListener(null);
            pro_detail.setKeyListener(null);
            ...
            proUpdateFlag.setVisibility(View.INVISIBLE);
            deleteBuss.setVisibility(View.INVISIBLE);
        }

        joinListView.setAdapter(new JoinAdapter(ProjectEditActivity.this,joinContactUserList));
        manaListView.setAdapter(new JoinAdapter(ProjectEditActivity.this,manaContactUserList));
    }

    private void setData(){
        for (int i = 0; i < joinList.size(); i++) {
            if(!joinList.get(i).getUSER_ID().equals(projectVo.getUSER_ID())){
        ...
        for (int i = 0; i < manaList.size(); i++) {
            if(!manaList.get(i).getUSER_ID().equals(projectVo.getUSER_ID())){
                ContactUser contactUser = new ContactUser();
                contactUser.setCheck(false);
    ...
    private void initDate(){
        ...
        for(int i=0;i<stuContactVoArrayList.size();i++){
            if(!stuContactVoArrayList.get(i).getUSER_ID().equals(projectVo.getUSER_ID())){
                ContactUser contactUser = new ContactUser();
                contactUser.setCheck(false);
        ...
        if(requestCode ==REQUEST_CODE){
            switch (resultCode){
                case USER_CODE:
                    ...
                    joinAdapter = new JoinAdapter(ProjectEditActivity.this,contactUsers);
                ...
                case USER_DELETE:
                    ...
                    joinAdapter = new JoinAdapter(ProjectEditActivity.this,deleteListUser);
                    joinListView.setAdapter(joinAdapter);
                    break;
                ...
                case DELETE_MANA:
                    ...
                    joinAdapter = new JoinAdapter(ProjectEditActivity.this,manaDeleList);
                    manaListView.setAdapter(joinAdapter);
                    break;
            }
        }
    ...
    private void initView() {
        proUpdateFlag = (TextView) findViewById(R.id.buss_to_pro);
        deleteBuss = (TextView) findViewById(R.id.deleteBuss);

        proUpdateFlag.setOnClickListener(this);
        ...
        pro_name = (EditText) findViewById(buss_name);
     //   buss_resource = (EditText) findViewById(buss_resource);
        pro_detail = (EditText) findViewById(buss_detail);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.back:
                ...
                break;
            case R.id.save:
                mWeiboDialog = WeiboDialogUtils.createLoadingDialog(ProjectEditActivity.this, "正在更新...");
                updateBuss();
                break;
            case R.id.deleteBuss:
                mWeiboDialog = WeiboDialogUtils.createLoadingDialog(ProjectEditActivity.this, "正在删除...");
                deletePro();
                break;
            case R.id.buss_to_pro:
                mWeiboDialog = WeiboDialogUtils.createLoadingDialog(ProjectEditActivity.this, "正在操作...");
                bussToPro();
                break;
            case R.id.beginTime:
                try {
            ...
            case R.id.addPeo:
                Intent addIntent = new Intent(ProjectEditActivity.this,AllUserActivity.class);
            ...
            case R.id.deletePeo:
                Intent deleteIntent = new Intent(ProjectEditActivity.this,AllUserActivity.class);
            ...
            case R.id.addManaPeo:
                Intent addManaIntent = new Intent(ProjectEditActivity.this,AllUserActivity.class);
            ...
            case R.id.deleteManaPeo:
                Intent deleteManaIntent = new Intent(ProjectEditActivity.this,AllUserActivity.class);
    ...
    private void updateBuss(){
        joinPeo.setLength(0);
        joinPeo.append(projectVo.getUSER_ID()+"-"+0+"&-&");
        ...
        OkGo.post(URL.UPDATE_PROJECT)
                .tag(this)
                .params("PROJECT_ID",projectVo.getPROJECT_ID())
                .params("PROJECT_NAME",pro_name.getText().toString().trim())
                .params("PROJECT_INFO",pro_detail.getText().toString().trim())
                .params("PROJECT_BEGIN_TIME",beginTime.getText().toString())
                .params("PROJECT_END_TIME",endTime.getText().toString())
                .params("PRO_MANA",joinPeo.toString())
                .params("PROJECT_TIME",timesFormat.format(new Date()))
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        try {
                            ...
                            if(jsonObject.getBoolean("success")){
                                Toast.makeText(ProjectEditActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                                finish();
                            }else{
                                Toast.makeText(ProjectEditActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                            }
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        ...
                        Toast.makeText(ProjectEditActivity.this, "网路请求失败", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void deletePro(){
        joinPeo.setLength(0);
        joinPeo.append(projectVo.getUSER_ID()+"&-&");
        ...
        OkGo.post(URL.DELETE_PROJECT)
                .tag(this)
                .params("PROJECT_ID",projectVo.getPROJECT_ID())
                .params("USER_ID",MyApplication.getUserVo().getUSER_ID())
                .params("PRO_NAME",pro_name.getText().toString().trim())
                .params("PRO_MANA",joinPeo.toString())
                .params("NAME",MyApplication.getUserVo().getNAME())
                .cacheKey("catchKey")
                .cacheMode(CacheMode.DEFAULT)
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        try {
                            jsonObject = new JSONObject(s);
                            if(jsonObject.getBoolean("success")){
                                Toast.makeText(ProjectEditActivity.this, "删除成功", Toast.LENGTH_SHORT).show();
                                finish();
                            }else{
                                Toast.makeText(ProjectEditActivity.this, "删除失败", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(ProjectEditActivity.this, "删除失败", Toast.LENGTH_SHORT).show();
                    ...
                    public void onError(Call call, Response response, Exception e) {
                        WeiboDialogUtils.closeDialog(mWeiboDialog);
                        super.onError(call, response, e);
                        Toast.makeText(ProjectEditActivity.this, "网络请求失败", Toast.LENGTH_SHORT).show();
                    }
                });
    }

    private void bussToPro(){
        OkGo.post(URL.UPDATE_PROJECT_FLAG)
                .tag(this)
                .params("PROJECT_ID",projectVo.getPROJECT_ID())
                .params("USER_ID",MyApplication.getUserVo().getUSER_ID())
                .params("PRO_NAME",pro_name.getText().toString().trim())
                ...
                .execute(new StringCallback() {
                    ...
                    public void onSuccess(String s, Call call, Response response) {
                        ...
                        try {
                            jsonObject = new JSONObject(s);
                            if(jsonObject.getBoolean("success")){
                                Toast.makeText(ProjectEditActivity.this, "操作成功", Toast.LENGTH_SHORT).show();
                                finish();
                            }else{
                                Toast.makeText(ProjectEditActivity.this, "操作失败", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(ProjectEditActivity.this, "操作失败", Toast.LENGTH_SHORT).show();
